...
<div class="admin-shell">
    ...
    <main class="admin-content">
        <section id="overview" class="admin-section">
            <div class="section-head">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin" class="inline-form">
                    <input type="hidden" name="action" value="seed-demo-data" />
                    <button type="submit" class="btn btn-soft">Populate Demo Data</button>
                </form>
            </div>
        ...
        <section id="destinations" class="admin-section panel">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin" class="admin-form-grid" style="margin-bottom: 12px;">
                <input type="hidden" name="action" value="add-destination" />
                <div class="input-wrap">
                    <label for="destCity">City</label>
                    <input id="destCity" type="text" name="city" required placeholder="Goa" />
                </div>
                <div class="input-wrap">
                    <label for="destCountry">Country</label>
                    <input id="destCountry" type="text" name="country" required placeholder="India" />
                </div>
                <div class="input-wrap">
                    <label for="destImageUrl">Image URL</label>
                    <input id="destImageUrl" type="text" name="imageUrl" placeholder="https://..." />
                </div>
                <div class="input-wrap full">
                    <label for="destDescription">Description</label>
                    <textarea id="destDescription" name="description" rows="2" placeholder="Short destination summary"></textarea>
                </div>
                <div class="admin-form-actions">
        ...
        <section id="experiences" class="admin-section panel">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin" class="admin-form-grid" style="margin-bottom: 12px;">
                ...
                <div class="input-wrap">
                    <label for="expDestinationId">Destination</label>
                    <select id="expDestinationId" name="destinationId" required>
                        <option value="">Select destination</option>
                        <c:forEach var="destination" items="${destinations}">
                            <option value="${destination.destinationId}">${destination.city}, ${destination.country}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="input-wrap">
                    <label for="expTitle">Title</label>
                    <input id="expTitle" type="text" name="title" required placeholder="Dolphin Cruise" />
                </div>
                <div class="input-wrap">
                    <label for="expType">Type</label>
                    <input id="expType" type="text" name="type" placeholder="Water Activity" />
                </div>
                <div class="input-wrap">
                    <label for="expPrice">Price</label>
                    <input id="expPrice" type="number" step="0.01" min="0" name="price" value="0" />
                </div>
                <div class="input-wrap">
                    <label for="expDuration">Duration (hours)</label>
                    <input id="expDuration" type="number" min="1" name="durationHours" value="1" />
                </div>
                <div class="input-wrap full">
                    <label for="expDescription">Description</label>
                    <textarea id="expDescription" name="description" rows="2" placeholder="Experience details"></textarea>
                </div>
                <div class="admin-form-actions">
        ...
        <section id="memories" class="admin-section panel">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin" class="admin-form-grid" style="margin-bottom: 12px;">
                <input type="hidden" name="action" value="add-memory" />
                <div class="input-wrap">
                    <label for="memoryUserId">User</label>
                    <select id="memoryUserId" name="userId" required>
                ...
                <div class="input-wrap">
                    <label for="memoryDestinationId">Destination</label>
                    <select id="memoryDestinationId" name="destinationId">
                ...
                <div class="input-wrap">
                    <label for="memoryImageUrl">Image URL</label>
                    <input id="memoryImageUrl" type="text" name="imageUrl" placeholder="https://..." />
                </div>
                <div class="input-wrap full">
                    <label for="memoryCaption">Caption</label>
                    <textarea id="memoryCaption" name="caption" rows="2" required placeholder="What happened on this trip?"></textarea>
                </div>
                <div class="admin-form-actions">
        ...
        <section id="budget" class="admin-section panel">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin" class="admin-form-grid" style="margin-bottom: 12px;">
                <input type="hidden" name="action" value="add-budget-rule" />
                <div class="input-wrap">
                    <label for="ruleMinBudget">Min Budget</label>
                    <input id="ruleMinBudget" type="number" step="0.01" min="0" name="minBudget" required />
                </div>
                <div class="input-wrap">
                    <label for="ruleMaxBudget">Max Budget</label>
                    <input id="ruleMaxBudget" type="number" step="0.01" min="0" name="maxBudget" required />
                </div>
                <div class="input-wrap">
                    <label for="ruleMinDays">Min Days</label>
                    <input id="ruleMinDays" type="number" min="1" name="minDays" required />
                </div>
                <div class="input-wrap">
                    <label for="ruleMaxDays">Max Days</label>
                    <input id="ruleMaxDays" type="number" min="1" name="maxDays" required />
                </div>
                <div class="input-wrap full">
                    <label for="ruleRecommendation">Recommendation</label>
                    <textarea id="ruleRecommendation" name="recommendation" rows="2" required placeholder="Suggested package strategy"></textarea>
                </div>
                <div class="admin-form-actions">
                    <button type="submit" class="btn btn-primary">Add Budget Rule</button>
                </div>
            </form>
            <c:choose>
        ...
        <section id="trip-tags" class="admin-section panel">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin" class="admin-form-grid" style="margin-bottom: 12px;">
                <input type="hidden" name="action" value="add-trip-tag" />
                <div class="input-wrap">
                    <label for="tagPackageId">Package</label>
                    <select id="tagPackageId" name="packageId" required>
                        <option value="">Select package</option>
                        <c:forEach var="pkgOpt" items="${bookingPackages}">
                            <option value="${pkgOpt.packageId}">${pkgOpt.title}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="input-wrap">
                    <label for="tripTag">Tag</label>
                    <input id="tripTag" type="text" name="tag" required placeholder="adventure" />
                </div>
                <div class="admin-form-actions">
                    <button type="submit" class="btn btn-primary">Add Trip Tag</button>
                </div>
            </form>
            <c:choose>
        ...
        <section id="pricing" class="admin-section panel">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin" class="admin-form-grid" style="margin-bottom: 12px;">
                <input type="hidden" name="action" value="add-pricing-rule" />
                <div class="input-wrap">
                    <label for="pricingLabel">Label</label>
                    <input id="pricingLabel" type="text" name="label" required placeholder="Festival Dynamic Rule" />
                </div>
                <div class="input-wrap">
                    <label for="pricingBase">Base Price</label>
                    <input id="pricingBase" type="number" step="0.01" min="0" name="basePrice" required />
                </div>
                <div class="input-wrap">
                    <label for="pricingPerPerson">Per Person</label>
                    <input id="pricingPerPerson" type="number" step="0.01" min="0" name="perPerson" required />
                </div>
                <div class="input-wrap">
                    <label for="pricingMultiplier">Duration Multiplier</label>
                    <input id="pricingMultiplier" type="number" step="0.01" min="0.1" name="durationMultiplier" required />
                </div>
                <div class="admin-form-actions">
                    <button type="submit" class="btn btn-primary">Add Pricing Rule</button>
                </div>
            </form>
            <c:choose>
        ...
        <section id="weather" class="admin-section panel">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin" class="admin-form-grid" style="margin-bottom: 12px;">
                <input type="hidden" name="action" value="add-destination-info" />
                <div class="input-wrap">
                    <label for="infoDestinationId">Destination</label>
                    <select id="infoDestinationId" name="destinationId" required>
                        <option value="">Select destination</option>
                        <c:forEach var="destination" items="${destinations}">
                            <option value="${destination.destinationId}">${destination.city}, ${destination.country}</option>
                        </c:forEach>
                ...
                <div class="input-wrap">
                    <label for="infoBestSeason">Best Season</label>
                    <input id="infoBestSeason" type="text" name="bestSeason" placeholder="Nov to Feb" />
                </div>
                <div class="input-wrap">
                    <label for="infoClimate">Climate</label>
                    <input id="infoClimate" type="text" name="climate" placeholder="Warm tropical" />
                </div>
                <div class="input-wrap full">
                    <label for="infoHighlights">Highlights</label>
                    <textarea id="infoHighlights" name="highlights" rows="2" placeholder="Beaches, nightlife, food"></textarea>
                </div>
                <div class="admin-form-actions">
                    <button type="submit" class="btn btn-primary">Add Destination Info</button>
                </div>
            </form>
            <c:choose>
